...
public class GuestActivityPopup extends AppCompatActivity implements NoteModeFragment.OnFragmentInteractionListener, VideoSearchFragment.OnFragmentInteractionListener{
...
//        tabs.addTab(tabs.newTab().setText("Search"));
    ...
    private void showpopup() {
        android.app.AlertDialog.Builder popup = new android.app.AlertDialog.Builder(GuestActivityPopup.this);
